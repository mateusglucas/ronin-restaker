...
# slp_weth_lp_staking_pool_addr = Web3.to_checksum_address('0xd4640c26c1a31cd632d8ae1a96fe5ac135d1eb52')
# axs_weth_lp_staking_pool_addr = Web3.to_checksum_address('0x487671acdea3745b6dac3ae8d1757b44a04bfe8a')

# # Liquidity pool tokens
# ron_usdc_lp_token_addr = Web3.to_checksum_address('0x4f7687affc10857fccd0938ecda0947de7ad3812')
# ron_weth_lp_token_addr = Web3.to_checksum_address('0x2ecb08f87f075b5769fe543d0e52e40140575ea7')
# ron_slp_lp_token_addr = Web3.to_checksum_address('0x8f1c5eda143fa3d1bea8b4e92f33562014d30e0d')
# ron_axs_lp_token_addr = Web3.to_checksum_address('0x32d1dbb6a4275133cc49f1c61653be3998ada4ff')
# usdc_weth_lp_token_addr = Web3.to_checksum_address('0xa7964991f339668107e2b6a6f6b8e8b74aa9d017')
# slp_weth_lp_token_addr = Web3.to_checksum_address('0x306a28279d04a47468ed83d55088d0dcd1369294')
# axs_weth_lp_token_addr = Web3.to_checksum_address('0xc6344bc1604fcab1a5aad712d766796e2b7a70b9')
...
# # Tokens
# wron_token_addr = Web3.to_checksum_address('0xe514d9deb7966c8be0ca922de8a064264ea6bcd4')
# slp_token_addr = Web3.to_checksum_address('0xa8754b9fa15fc18bb59458815510e40a12cd2014')
# axs_token_addr = Web3.to_checksum_address('0x97a9107c1793bc407d6f527b77e7fff4d812bece')
# usdc_token_addr = Web3.to_checksum_address('0x0b7007c13325c48911f73a2dad5fa5dcbf808adc')
# weth_token_addr = Web3.to_checksum_address('0xc99a6a985ed2cac1ef41640596c5a5f9f4e19ef5')